...
Section {
    caption: qsTr("Tapered Capsule Geometry")
    width: parent.width

    SectionLayout {
        PropertyLabel {
            text: qsTr("Height")
            tooltip: qsTr("Sets the height of the tapered capsule.")
        }
        ...
        PropertyLabel {
            ...
            tooltip: qsTr("Sets the diameter at the top of the capsule.")
        }
        ...
        PropertyLabel {
            ...
            tooltip: qsTr("Sets the diameter at the bottom of the capsule.")
        }
