...
public:
    ...
    virtual void onCharacterContactAdded(const Contact &contact, CharacterContactSettings &settings) = 0;
    virtual void onCharacterContactSolve(const Contact &contact, const QVector3D &contactVelocity, const QVector3D &characterVelocity, QVector3D &newCharacterVelocity) = 0;
