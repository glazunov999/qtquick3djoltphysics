...
class Q_QUICK3DJOLTPHYSICS_EXPORT PhysicsSettings : public QObject
{
    ...
    Q_PROPERTY(quint32 numVelocitySteps READ numVelocitySteps WRITE setNumVelocitySteps NOTIFY numVelocityStepsChanged)
...
public:
    ...
    quint32 numVelocitySteps() const;
    void setNumVelocitySteps(quint32 numVelocitySteps);

    quint32 numPositionSteps() const;
    void setNumPositionSteps(quint32 numPositionSteps);
...
signals:
    ...
    void numVelocityStepsChanged(quint32 numVelocitySteps);
    void numPositionStepsChanged(quint32 numPositionSteps);
