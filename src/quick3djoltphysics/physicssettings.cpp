...
quint32 PhysicsSettings::numVelocitySteps() const
{
    return m_physicsSettings.mNumVelocitySteps;
}

void PhysicsSettings::setNumVelocitySteps(quint32 numVelocitySteps)
{
...
quint32 PhysicsSettings::numPositionSteps() const
{
    return m_physicsSettings.mNumPositionSteps;
}

void PhysicsSettings::setNumPositionSteps(quint32 numPositionSteps)
{
