...
public:
    ...
    QVector3D staticPosition() const;
    void setStaticPosition(const QVector3D &position);
    QQuaternion staticRotation() const;
    void setStaticRotation(const QQuaternion &rotation);
    QVector3D staticEulerRotation() const;
    void setStaticEulerRotation(const QVector3D &eulerRotation);
    QVector3D staticPivot() const;
    void setStaticPivot(const QVector3D &pivot);
...
private:
    ...
    bool m_kinematicWasMoved = false;
