        ...
        Body {
            ...
            Model {
                ...
                materials: PrincipledMaterial {
                    ...
                    metalness: 0.5
                    roughness: 0.1
                    baseColor: colors[cone1.bodyID % colors.length]
                }
            }
        }
        ...
        Body {
            ...
            Model {
                ...
                materials: PrincipledMaterial {
                    ...
                    metalness: 0.5
                    roughness: 0.1
                    baseColor: colors[cone2.bodyID % colors.length]
                }
            }
        }
        ...
        Body {
            ...
            Model {
                ...
                materials: PrincipledMaterial {
                    ...
                    metalness: 0.5
                    roughness: 0.1
                    baseColor: colors[cone3.bodyID % colors.length]
                }
            }
        }

        Component {
            id: taperedCylinderComponent
            Body {
                id: taperedCylinderBody
                shape: TaperedCylinderShape {
                    height: 10
                    topDiameter: 1
                    bottomDiameter: 2
                ...
                Model {
                    ...
                    materials: PrincipledMaterial {
                        ...
                        metalness: 0.0
                        roughness: 0.1
                        baseColor: colors[taperedCylinderBody.bodyID % colors.length]
                    }
                }
            }
        }
        ...
        Component.onCompleted: {
            for (let i = 0; i < 10; ++i) {
                for (let j = 0; j < 2; ++j) {
                    ...
                    taperedCylinderComponent.createObject(viewport.scene, {
                        position: position,
