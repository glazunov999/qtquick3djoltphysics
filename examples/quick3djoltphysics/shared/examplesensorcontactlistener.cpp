...
void ExampleSensorContactListener::contactAdded(const BodyContact &bodyContact, ContactSettings &settings)
{
...
void ExampleSensorContactListener::contactPersisted(const BodyContact &bodyContact, ContactSettings &settings)
{
}
