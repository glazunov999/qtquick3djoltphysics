#ifndef EXAMPLESOFTBODYCLOTHMESHGEOMETRY_H
#define EXAMPLESOFTBODYCLOTHMESHGEOMETRY_H

#include <QtQuick3DJoltPhysics/softbodymeshgeometry.h>
#include <QVector>
#include <QVector2D>

class ExampleSoftBodyClothMeshGeometry : public SoftBodyMeshGeometry
{
    Q_OBJECT
public:
    explicit ExampleSoftBodyClothMeshGeometry();
...
#endif // EXAMPLESOFTBODYCLOTHMESHGEOMETRY_H
